...
import ImageModal from "../Componente/ImageModal"; // 🔹 import modal imagine
...
const Bauturi = () => {
  ...
  const [selectedImage, setSelectedImage] = useState<string | null>(null); // 🔹 modal imagine
